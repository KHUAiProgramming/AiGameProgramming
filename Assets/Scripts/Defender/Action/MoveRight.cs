...
public class MoveRight : ActionNode
{
    public MoveRight(MonoBehaviour owner, Blackboard blackboard) : base(owner, blackboard) { }

    public override NodeState Evaluate()
    {
        //Debug.Log("Moving right from enemy...");
        ...
        controller.Move(self.transform.right);
